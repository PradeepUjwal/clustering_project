...
def main():
    ...
    health = str.text_input('Enter the % of GDP spent on health')
    export = str.text_input('Enter the % of GDP spent on exports')
    impor = str.text_input('Enter the % of GDP spent on imports')
    gdp = str.text_input('Enter the GDP per population')
